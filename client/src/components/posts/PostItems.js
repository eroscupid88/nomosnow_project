...
import { deletePost, addLike, addDisLike } from '../../action/postAction';
            ...
            {showActions ? (
              <span>
                <button
                  ...
                  type="button"
                  className="btn btn-light btn-outline-success mr-1"
                >
                  <i
                ...
                <button
                  ...
                  type="button"
                  className="btn btn-light btn-outline-danger mr-5"
                >
                  <i
                    className={classnames('fas fa-thumbs-down danger ', {
